...
import '../../features/veganHome/screens/awaitingPayment.dart' as _i5;
import '../../features/veganHome/screens/checkout_screen.dart' as _i3;
import '../../features/veganHome/screens/orderConfirmed.dart' as _i4;
...
import '../../models/restaurant/restaurantMenuItem.dart' as _i8;
...
class RootRouter extends _i6.RootStackRouter {
  ...
  final Map<String, _i6.PageFactory> pagesMap = {
    ...
    OrderConfirmedScreen.name: (routeData) {
      return _i6.CustomPage<dynamic>(
          routeData: routeData,
          child: const _i4.OrderConfirmedScreen(),
    ...
    AwaitingPaymentPage.name: (routeData) {
      return _i6.MaterialPageX<dynamic>(
          routeData: routeData, child: const _i5.AwaitingPaymentPage());
    }
  };

  @override
  List<_i6.RouteConfig> get routes => [
        _i6.RouteConfig(VeganHomeScreen.name, path: '/'),
        _i6.RouteConfig(RestaurantMenuScreen.name,
            path: '/restaurant-menu-screen'),
        _i6.RouteConfig(CheckoutScreen.name, path: '/checkout-screen'),
        _i6.RouteConfig(OrderConfirmedScreen.name,
            path: '/order-confirmed-screen'),
        _i6.RouteConfig(AwaitingPaymentPage.name,
...
/// generated route for
/// [_i1.VeganHomeScreen]
class VeganHomeScreen extends _i6.PageRouteInfo<void> {
...
class RestaurantMenuScreen extends _i6.PageRouteInfo<RestaurantMenuScreenArgs> {
  RestaurantMenuScreen(
      {_i7.Key? key, required List<_i8.RestaurantMenuItem> menuList})
...
class RestaurantMenuScreenArgs {
  ...
  final List<_i8.RestaurantMenuItem> menuList;
...
/// generated route for
/// [_i3.CheckoutScreen]
class CheckoutScreen extends _i6.PageRouteInfo<void> {
...
/// generated route for
/// [_i4.OrderConfirmedScreen]
class OrderConfirmedScreen extends _i6.PageRouteInfo<void> {
...
/// generated route for
/// [_i5.AwaitingPaymentPage]
class AwaitingPaymentPage extends _i6.PageRouteInfo<void> {
