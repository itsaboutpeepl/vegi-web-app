...
import 'package:vegan_liverpool/redux/viewsmodels/pickupCard.dart';
...
class _PickUpCardState extends State<PickUpCard> {
  ...
  Widget build(BuildContext context) {
    return StoreConnector<AppState, PickUpCardViewModel>(
      converter: PickUpCardViewModel.fromStore,
      distinct: true,
      builder: (_, viewmodel) {
        return Container(
